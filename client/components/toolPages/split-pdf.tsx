    ...
    <div className="flex flex-1 items-center justify-center h-full px-4 py-6">
      <Tabs defaultValue="pages">
        <TabsList className="w-full mx-auto">
          <TabsTrigger value="pages" disabled={!!file}>
            Exclude Pages
          </TabsTrigger>
          <TabsTrigger value="range" disabled={!!file}>
            Range
          </TabsTrigger>
        </TabsList>
            ...
            <Card className="w-full max-w-xl sm:max-w-2xl md:max-w-3xl border-border bg-background p-6 sm:p-8 flex flex-col items-center justify-center rounded-2xl shadow-sm">
              {!file ? (
                <div className="flex w-full flex-col gap-6">
                  <div
                    className={`border-2 border-dashed rounded-xl w-full py-16 flex flex-col items-center justify-center transition-all duration-200 cursor-pointer ${
                      dragActive
                  ...
                  {isConverting ? (
                    <Empty className="w-full">
                      <EmptyHeader>
                        ...
                        <EmptyTitle className="text-orange-300 text-lg sm:text-xl">
                          Splitting PDF
                        </EmptyTitle>
                        <EmptyDescription className="text-sm sm:text-base">
                          Please wait while PDF is being splitted. Do not
                          refresh the page.
                        </EmptyDescription>
                      </EmptyHeader>
                    </Empty>
                    ...
                    <div className=" flex flex-col gap-4">
                      <Label htmlFor="exclude-pages">
                        Enter pages to exclude (comman separated)
                      </Label>
                      <Input
                        type="text"
                        name="exclude-pages"
              ...
              {!file ? (
                <div className="flex w-full flex-col gap-6">
                  ...
                  >
                    <Upload className="text-orange-300 mb-3" size={40} />
                    <p className="text-sm sm:text-base text-orange-300 text-center">
                      Drop your PDF file here or click to upload <br /> to split
                      by range
                    </p>
                    <p className="text-muted-foreground text-sm">
                      (Max File Size: 5MB)
                ...
                <div className="flex flex-col items-center text-center space-y-5 w-full">
                  ...
                  {isConverting ? (
                    ...
                    <div className=" flex flex-col gap-4">
                      <Label htmlFor="include-range">
                        Enter range of pages to include (comman separated)
                      </Label>
                      <Input
                        type="text"
                        name="include-range"
